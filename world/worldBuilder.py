...
from world.agents.HumanBrain import HumanBrain
from world.agents.Spy import Spy
...
def create_builder(agent, max_nr_ticks, tick_duration):
    ...
    builder = WorldBuilder(shape=[24, 25], tick_duration=tick_duration, run_matrx_api=True,
                           ...
                           visualization_bg_img="/images/background_70.svg")
...
def add_drop_off_zones(builder):
    builder.add_area((1, 23), width=8, height=1, name=f"Drop off 0", visualize_opacity=0.5,
...
def add_agents(builder, agent):
    ...
    builder.add_agent((9, 23), agent, team="Team 0", name=f"Agent 0 in Team 0",
    ...
    human = HumanBrain(max_carry_objects=1, grab_range=0, drop_range=0, fov_occlusion=fov_occlusion)
    builder.add_human_agent((10, 23), human, team="Team 0", name=f"Human 0 in Team 0",
...
def create_world(builder):
    ...
    bush_locations = [(1, 12), (1, 13), (1, 14), (1, 15), (1, 16), (5, 16), (5, 15), (5, 14), (7, 14), (7, 15), (7, 16),
                      (11, 14), (11, 15), (11, 16),
                      (3, 12), (22, 11), (21, 11), (20, 11), (19, 11), (18, 11), (17, 11), (1, 6), (2, 6), (3, 6),
                      (16, 10), (16, 11), (5, 6), (6, 6), (7, 6), (8, 6), (9, 6), (10, 6), (11, 6), (12, 6), (13, 6),
                      (14, 6), (14, 7), (14, 8), (14, 9), (14, 10), (14, 11), (14, 12), (14, 13), (14, 14), (14, 15),
                      (14, 16), (14, 17), (14, 19), (14, 20), (14, 21), (14, 22), (14, 23),
                      (3, 22), (2, 22), (5, 22), (6, 22), (7, 22), (8, 22), (1, 22)]
    path_locations = [(2, 5), (3, 5), (4, 5), (5, 5), (6, 5), (7, 5), (8, 5), (9, 5), (10, 5), (11, 5), (12, 5),
                      (13, 5), (14, 5), (15, 5), (16, 5), (8, 1), (12, 1), (3, 13), (2, 13), (2, 12),
                      (4, 6), (4, 7), (4, 8), (4, 9), (4, 10), (4, 11), (4, 12), (4, 13), (5, 13), (6, 13), (7, 13),
                      (8, 13), (9, 13), (1, 5), (4, 1), (3, 14), (3, 15), (3, 16), (9, 14), (9, 15), (9, 16),
                      (10, 13), (11, 13), (12, 13), (13, 13), (13, 14), (13, 15), (13, 16), (13, 17), (13, 18),
                      (14, 18), (15, 18), (13, 19), (13, 20), (13, 21), (12, 21), (11, 21), (10, 21), (9, 21), (8, 21),
                      (7, 21), (6, 21), (5, 21),
                      (4, 21), (4, 22), (9, 23), (10, 23), (9, 22), (10, 22), (1, 1), (1, 2), (1, 3), (1, 4)]
    fence_locations = [(6, 2), (6, 3), (6, 4), (10, 2), (10, 3), (10, 4), (14, 2), (14, 3), (14, 4), (2, 2), (2, 3),
                       (2, 4), (2, 1), (6, 1), (10, 1), (14, 1), (6, 20), (6, 19), (6, 18), (6, 17), (6, 16), (6, 15),
                       (6, 14),
                       (12, 14), (12, 15), (12, 16), (12, 17), (12, 18), (12, 19), (12, 20)]
    plant_locations = [(15, 13), (15, 14), (15, 15), (15, 16), (15, 17), (15, 19), (15, 20), (15, 21), (15, 22),
                       (15, 23), (2, 16), (2, 15), (2, 14), (4, 14), (4, 15), (4, 16), (8, 14), (8, 15), (8, 16),
                       (10, 14), (10, 15), (10, 16)]
    for bush_loc in bush_locations:
        builder.add_object(bush_loc, 'bush', EnvObject, is_traversable=False, is_movable=False, visualize_shape='img',
                           img_name="/images/tree.svg")
    for path_loc in path_locations:
        builder.add_object(path_loc, 'path', EnvObject, is_traversable=True, is_movable=False, visualize_shape='img',
                           img_name="/images/paving10.svg")
    for fence_loc in fence_locations:
        builder.add_object(fence_loc, 'fence', EnvObject, is_traversable=False, is_movable=False, visualize_shape='img',
                           img_name="/images/fence.svg")
    for plant_loc in plant_locations:
        builder.add_object(plant_loc, 'plant', EnvObject, is_traversable=False, is_movable=False, visualize_shape='img',
                           img_name="/images/pool20.svg")

    builder.add_object((3, 1), 'bbq', EnvObject, is_traversable=False, is_movable=False, visualize_shape='img',
                       img_name="/images/bbq2.svg")
    builder.add_object((5, 1), 'tree', EnvObject, is_traversable=False, is_movable=False, visualize_shape='img',
                       img_name="/images/tree.svg")
    builder.add_object((7, 1), 'umbrella', EnvObject, is_traversable=False, is_movable=False, visualize_shape='img',
                       img_name="/images/umbrella2.svg")
    builder.add_object((9, 1), 'tree', EnvObject, is_traversable=False, is_movable=False, visualize_shape='img',
                       img_name="/images/tree.svg")
    builder.add_object((13, 1), 'tree', EnvObject, is_traversable=False, is_movable=False, visualize_shape='img',
                       img_name="/images/tree.svg")
    builder.add_object((11, 1), 'tree', EnvObject, is_traversable=False, is_movable=False, visualize_shape='img',
                       img_name="/images/tree.svg")
    builder.add_object((12, 22), 'ball', EnvObject, is_traversable=False, is_movable=True, visualize_shape='img',
                       img_name="/images/soccer-ball.svg")

    # Create the rooms
    # room_locations = add_rooms(builder)
    builder.add_room(top_left_location=(17, 1), width=6, height=10, name='area A4', door_locations=[(17, 5)],
                     doors_open=True, wall_visualize_colour=wall_color,
                     with_area_tiles=True, area_custom_properties={'doormat': (16, 5)},
                     area_visualize_colour=room_colors[0], area_visualize_opacity=0.0)
    builder.add_room(top_left_location=(3, 2), width=3, height=3, name='area A1', door_locations=[(4, 4)],
                     doors_open=True, wall_visualize_colour=wall_color,
                     with_area_tiles=True, area_custom_properties={'doormat': (4, 5)},
                     area_visualize_colour=room_colors[0], area_visualize_opacity=0.0)
    builder.add_room(top_left_location=(7, 2), width=3, height=3, name='area A2', door_locations=[(8, 4)],
                     doors_open=True, wall_visualize_colour=wall_color,
                     with_area_tiles=True, area_custom_properties={'doormat': (9, 4)},
                     area_visualize_colour=room_colors[0], area_visualize_opacity=0.0)
    builder.add_room(top_left_location=(11, 2), width=3, height=3, name='area A3', door_locations=[(12, 4)],
                     doors_open=True, wall_visualize_colour=wall_color,
                     with_area_tiles=True, area_custom_properties={'doormat': (12, 5)},
                     area_visualize_colour=room_colors[0], area_visualize_opacity=0.0)
    builder.add_room(top_left_location=(1, 7), width=3, height=5, name='area B1', door_locations=[(2, 11)],
                     doors_open=True, wall_visualize_colour=wall_color,
                     with_area_tiles=True, area_custom_properties={'doormat': (2, 12)},
                     area_visualize_colour=room_colors[0], area_visualize_opacity=0.0)
    builder.add_room(top_left_location=(5, 7), width=9, height=6, name='area B2', door_locations=[(9, 12)],
                     doors_open=True, wall_visualize_colour=wall_color,
                     with_area_tiles=True, area_custom_properties={'doormat': (9, 13)},
                     area_visualize_colour=room_colors[0], area_visualize_opacity=0.0)
    builder.add_room(top_left_location=(1, 17), width=5, height=4, name='area C1', door_locations=[(3, 17)],
                     doors_open=True, wall_visualize_colour=wall_color,
                     with_area_tiles=True, area_custom_properties={'doormat': (3, 16)},
                     area_visualize_colour=room_colors[0], area_visualize_opacity=0.0)
    builder.add_room(top_left_location=(7, 17), width=5, height=4, name='area C2', door_locations=[(9, 17)],
                     doors_open=True, wall_visualize_colour=wall_color,
                     with_area_tiles=True, area_custom_properties={'doormat': (9, 16)},
                     area_visualize_colour=room_colors[0], area_visualize_opacity=0.0)
    builder.add_room((16, 13), 7, 11, 'area C3', door_locations=[(16, 18)], doors_open=True,
                     wall_visualize_colour=wall_color,
                     with_area_tiles=True, area_custom_properties={'doormat': (15, 18)},
                     area_visualize_colour=room_colors[0], area_visualize_opacity=0.0)
    ...
    for loc in man_locs:
        builder.add_object(loc, 'healthy man', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy man.svg")
    for loc in woman_locs:
        builder.add_object(loc, 'healthy woman', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy woman.svg")
    for loc in granny_locs:
        builder.add_object(loc, 'healthy elderly man', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy elderly man.svg")
    ...
    builder.add_object((1, 23), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                       img_name="/images/critically injured girl.svg", drop_zone_nr=0)
    builder.add_object((2, 23), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                       img_name="/images/critically injured elderly woman.svg", drop_zone_nr=0)
    builder.add_object((3, 23), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                       img_name="/images/critically injured man.svg", drop_zone_nr=0)
    builder.add_object((4, 23), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                       img_name="/images/critically injured dog.svg", drop_zone_nr=0)
    builder.add_object((5, 23), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                       img_name="/images/mildly injured boy.svg", drop_zone_nr=0)
    builder.add_object((6, 23), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                       img_name="/images/mildly injured elderly man.svg", drop_zone_nr=0)
    builder.add_object((7, 23), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                       img_name="/images/mildly injured woman.svg", drop_zone_nr=0)
    builder.add_object((8, 23), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                       img_name="/images/mildly injured cat.svg", drop_zone_nr=0)

    builder.add_object(location=[4, 4], is_traversable=True, is_movable=False, name="area A1 sign",
                       img_name="/images/area1_new.svg", visualize_depth=110, visualize_size=0.55)
    builder.add_object(location=[8, 4], is_traversable=True, is_movable=False, name="area A2 sign",
                       img_name="/images/areaA2.svg", visualize_depth=110, visualize_size=0.6)
    builder.add_object(location=[12, 4], is_traversable=True, is_movable=False, name="area A3 sign",
                       img_name="/images/areaA3.svg", visualize_depth=110, visualize_size=0.6)
    builder.add_object(location=[17, 5], is_traversable=True, is_movable=False, name="area A4 sign",
                       img_name="/images/areaA4.svg", visualize_depth=110, visualize_size=0.65)
    builder.add_object(location=[2, 11], is_traversable=True, is_movable=False, name="area B1 sign",
                       img_name="/images/areaB1.svg", visualize_depth=110, visualize_size=0.5)
    builder.add_object(location=[9, 12], is_traversable=True, is_movable=False, name="area B2 sign",
                       img_name="/images/areaB2.svg", visualize_depth=110, visualize_size=0.6)
    builder.add_object(location=[3, 17], is_traversable=True, is_movable=False, name="area C1 sign",
                       img_name="/images/areaC1.svg", visualize_depth=110, visualize_size=0.5)
    builder.add_object(location=[9, 17], is_traversable=True, is_movable=False, name="area C2 sign",
                       img_name="/images/areaC2.svg", visualize_depth=110, visualize_size=0.6)
    builder.add_object(location=[16, 18], is_traversable=True, is_movable=False, name="area C3 sign",
                       img_name="/images/areaC3.svg", visualize_depth=110, visualize_size=0.6)
